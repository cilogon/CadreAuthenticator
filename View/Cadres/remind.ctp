<?php
/**
 * COmanage Registry CADRE Remind (Username Reminder) View
 *
 ...
 */
  ...
  $params = array('title' => _txt('pl.cadreauthenticator.token.usernamereminder'));
...
<div class="ui-state-highlight ui-corner-all co-info-topbox">
  ...
  <strong><?php print _txt('pl.cadreauthenticator.usernamereminder.info'); ?></strong>
</div>
  ...
  <li>
    <div class="field-name vtop">
      <div class="field-title">
        <?php print _txt('pl.cadreauthenticator.remind.q'); ?>
      </div>
    </div>
